...
class Digitizer:
    ...
    def __init__(self, params):
        ...
        self._zero_suppression: bool = params.get("zero_suppression", False)
    ...
    def __str__(self):
        return f"Digitizer(id={self._id}, family={self._family}, version={self._version}, serial_number={self._serial_number}, num_channels={self._num_channels}, bits={self._bits}, frequency={self._frequency}, max_samples={self._max_samples}, channel_groups={self._channel_groups}, zero_supression={self._zero_suppression}, inspection={self._inspection}, dual_edge={self._dual_edge}, voltage_range={self._voltage_range})"
